      ...
      <div className="flex flex-col justify-center p-5 border shadow-md rounded-xl">
        ...
        <div className="table w-full p-5">
          <div className="table-row-group">
            <div className="table-row text-white" style={{ backgroundColor: "#198e7d" }}>
            ...
            {clients.map((client) => (
              <div className="table-row hover:cursor-pointer hover:bg-gray-100" key={client._id}>
                <div className="table-cell p-2 border border-r-0">{client.name}</div>
                <div className="table-cell p-2 border border-l-0 border-r-0">{client.address}</div>
                <div className="table-cell p-2 border border-l-0">{client.phone}</div>
              </div>
            ))}
          </div>
        </div>
